<template>
    ...
    <div class="phoneGround">
        <div class="updown">
            ...
            <div class="right" @click="hideKeyboard">
                <div class="exp1">
                    <b>비밀번호 입력</b>이 번거로우신가요?
                </div>
                <img src="/image/loginSelect/fingerPrint.png" width="350px" height="350px">
                <div class="exp2">
                    편리한 지문 로그인을 사용해보세요!
                </div>
                <div class="btn" @click="fingerEnroll">
                    지문 등록하기
                </div>
            </div>
        </div>
