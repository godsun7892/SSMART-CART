...
![쇼핑편의기능](/exec/image/쇼핑편의기능.PNG)
  - 상품을 검색하여 내가 원하는 상품 검색 및 위치 찾기
  - 가장 세일이 많이 되는 상품 확인

  ## 3-4. ssamart-cart 오늘의 메뉴 추천
![메뉴추천](/exec/image/메뉴추천.PNG)
  
  오늘 무엇을 먹을지 고민될 때, 저녁 메뉴를 추천받으세요!
  
  - 랜덤으로 메뉴가 하나 추천됨
  - 우리 매장에서 판매하는 해당 재료와 위치 제공
  - 레시피 제공

  ## 3-5. ssamart-cart 위치안내
![위치안내](/exec/image/위치안내.PNG)
  - 지도에서 상품 위치 검색을 하면 지도에서 위치 표기

  ## 3-6. ssamart-cart 결제
![결제](/exec/image/결제.PNG)
![결제기능](/exec/image/결제기능.PNG)

  - 웹에서 결제 카드 등록 가능
  - 카트를 끌고 매장에서 결제 구역을 통과할 시 등록된 카드로 자동 결제
  - UWB 원리 이용
